...
Now the installation is complete and it will show you a screen with the IP address of the Admin webpage and Admin password. Take note of these for future use. (Note: your IP address and password will be different than what's shown)
